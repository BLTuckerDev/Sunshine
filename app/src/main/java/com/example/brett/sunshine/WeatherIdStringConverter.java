...
public final class WeatherIdStringConverter {

    private static WeatherIdStringConverter converter;


    public static synchronized WeatherIdStringConverter getConverter(){
        if(null == converter){
            converter = new WeatherIdStringConverter();
        }
