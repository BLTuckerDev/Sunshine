 ...
 */
package com.example.brett.sunshine.muzei;
...
public class WeatherMuzeiSource extends MuzeiArtSource {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        boolean dataUpdated = intent != null && SunshineSyncAdapter.ACTION_MUZEI_UPDATED.equals(intent.getAction());
    ...
    protected void onUpdate(int reason) {
        ...
        Cursor cursor = getContentResolver().query(weatherForLocationUri, FORECAST_COLUMNS, null,
                null, WeatherContract.WeatherEntry.COLUMN_DATETEXT + " ASC");
        ...
        if (cursor.moveToFirst()) {
            ...
            String imageUrl = new WeatherResourceConverter().getImageUrlForWeatherCondition(weatherId);
