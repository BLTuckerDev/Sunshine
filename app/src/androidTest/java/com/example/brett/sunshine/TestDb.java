...
import com.example.brett.sunshine.data.WeatherDbHelper;
import com.example.brett.sunshine.data.WeatherContract.LocationEntry;
import com.example.brett.sunshine.data.WeatherContract.WeatherEntry;
...
public class TestDb extends AndroidTestCase {
    ...
    public void testInsertReadDb() {
		...
		String weatherDateTestValue = "20141205";
		double degreesTestValue = 1.1;
		double humidityTestValue = 1.2;
		double pressureTestValue = 1.3;
		int maxTempTestValue = 75;
		int minTempTestValue = 65;
		String weatherDescriptionTestValue = "Asteroids";
		double windSpeedTestValue = 5.5;
		int weatherIdTestValue = 321;
		...
		if(weatherCursor.moveToFirst()){
			...
			fail("No weather results returned");
		}
